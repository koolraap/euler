...
{
    public class Problem18 : IProblem<long>
    {
        public async Task<long> Solve()
        {
            ...
            var head = NodeBuilder.Build(tree);

            var result = head.Walk<long>((n) =>
            {
                ...
                {
                    n.MaxPath = n.Value + Math.Max(n.Left.MaxPath, n.Right.MaxPath);
                }
